+-    <%@ page contentType="text/html"%>  
   ...
   function enviar(par){  
      ...
      if (par == 'cadastrar'){  
		 ...
		 }else if (document.cadastro.tpp_codigo.value == ''){  
   ...
   <table width="" border="">  
     ...
     <tr>  
       <td height="" bgcolor="red">
          ...
          <input name="pro_descricaoField" type="text" id="pro_descricaoField" size="" value="<%=(pro_descricao==null)?"":pro_descricao%>"></p>  
            <p><strong>Codigo:</strong>        
          <input name="tpp_codigoField" type="text" id="tpp_codigoField" size="" value="<%=(tpp_codigo==null)?"":tpp_codigo%>"> </p>          
            <p><strong>Preco Custo:</strong>   
          <input name="pro_precocustoField" type="text" id="pro_precocustoField" size="" value="<%=(pro_precocusto==null)?"":pro_precocusto%>"></p>  
            <p><strong>Preco Venda:</strong>   
          <input name="pro_precovendaField" type="text" id="pro_precovendaField" size="" value="<%=(pro_precovenda==null)?"":pro_precovenda%>"></p>
            <p><strong>Estoque:</strong>   
          <input name="pro_estoqueField" type="text" id="pro_estoqueField" size="" value="<%=(pro_estoque==null)?"":pro_estoque%>"></p>
