    ...
    public class Conexao_itensvenda {  
      ...
      private char      itv_embalagem = 0;
	  private float     itv_qtde = 0;
	  private float     itv_valorun = 0;
      private float     itv_desc = 0; 	  
      private float     itv_valortotal = 0;
      ...
      public void setTpg_codigo(int fun_codigo){  
	 ...
	 public String getItv_valortotal(){  
      ...
      public void inserirDados(){  
         ...
         try {  
            String query = "insert into itensvenda(itv_codigo,ven_codigo,pro_codigo,tpp_codigo,nf_codigo,tpg_codigo,fun_codigo,itv_embalagem,itv_qtde,itv_valorun,itv_desc,itv_valortotal) "
                    + "values("+itv_codigo+","+ven_codigo+","+pro_codigo+","+tpp_codigo+","+nf_codigo+","+tpg_codigo+","+fun_codigo+","+itv_embalagem+","+itv_qtde+","+itv_valorun+","+itv_desc+","+itv_valortotal+")";  
      ...
      public boolean alterarDados(){  
         ...
         try {  
            String query = "update itensvenda "+  
      ...
      public boolean excluirDados(){  
       ...
       boolean testa = false;  
         ...
         try {  
            String query = "delete from itensvenda where itv_codigo='" +itv_codigo+"'";  
            int linhas = stm.executeUpdate(query);  
     ...
     public boolean consultarDados(){  
        ...
        try {  
           String query = "select * from itensvenda where itv_codigo='" + itv_codigo+"'";  
     ...
     public void setConsulta() {  
        ...
        try {  
           res = stm.executeQuery("select * from itensvenda");  
        }   
