    ...
    public class Conexao_vendas {  
      ...
      private String    ven_datavenda = 0;
	  private float     ven_valortotal = 0;
      private String    ven_observacoes = 0; 	  
     
      public Conexaovendas() {  
	  ...
	  public void SetVen_datavenpra(String ven_datavenda){  
         this.ven_datavenda = ven_datavenda;  
      }  
       
	    public void SetVen_valortotal(float ven_valortotal){  
	 ...
	 public String getTpg_codigo(){  
      ...
      public void inserirDados(){  
         ...
         try {  
            String query = "insert into vendas(ven_codigo,fun_codigo,tpg_codigo,nf_codigo,ven_datavenda,ven_valortotal,ven_observacoes) "
                    + "values("+ven_codigo+","+fun_codigo+","+tpg_codigo+","+nf_codigo+","+ven_datavenda+","+ven_valortotal+","+ven_observacoes+")";  
      ...
      public boolean excluirDados(){  
       ...
       boolean testa = false;  
         ...
         try {  
            String query = "delete from vendas where ven_codigo='" +ven_codigo+"'";  
            int linhas = stm.executeUpdate(query);  
     ...
     public boolean consultarDados(){  
        ...
        try {  
           String query = "select * from vendas where ven_codigo='" + ven_codigo+"'";  
     ...
     public void setConsulta() {  
        ...
        try {  
           res = stm.executeQuery("select * from vendas");  
        }   
